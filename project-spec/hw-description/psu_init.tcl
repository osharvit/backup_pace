...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A004C 0x00003F00 0x00000100
		# : DPLL FRAC CFG
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01010500
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01010500
    ...
    mask_write 0XFF5E00C0 0x013F3F07 0x01010C03
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
    ...
    mask_write 0XFF5E0104 0x00000007 0x00000001
    ...
    mask_write 0XFD1A00C0 0x01003F07 0x01000403
    ...
    mask_write 0XFD1A00C4 0x01003F07 0x01000C03
...
set psu_mio_init_data {
    ...
    mask_write 0XFF18006C 0x000000FE 0x000000A0
    ...
    mask_write 0XFF1800D8 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800DC 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800E0 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800E4 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800E8 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800F4 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800F8 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800FC 0x000000FE 0x00000080
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00202004
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF5E0238 0x00002000 0x00000000
		# : UART
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
