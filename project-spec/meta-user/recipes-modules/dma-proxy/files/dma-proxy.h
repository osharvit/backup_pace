...
/*#define BUFFER_SIZE (10240 * 1024)*/	 	/* must match driver exactly */
#define BUFFER_SIZE (50000 * 1024)	 	/* must match driver exactly */
...
#define XFER_CYCLE		_IOR('a','d',int32_t*)
#define START_XFER_CYCLE		_IOR('a','e',int32_t*)
#define STOP_DMA		_IOW('a','f',int32_t*)
