...
class re_thread : public thread_base, public stm, public hswi_json
{
    ...
    protected:
        ...
        // tx_carrier_nr:n
        //---------------------------------------------------------------------
        bool delete_obj_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool create_obj_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool create_obj_rsp__tx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool modify_param_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool get_param_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                           const std::string& node_key,
                                           const int &inst_id,
                                           const size_t uid,
                                           rapidjson::Value &rsp_node,
                                           ...
                                           size_t item_idx = 0,
                                           size_t num_item = 1);
        bool modify_state_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool modify_state_rsp__tx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool state_change_ind__tx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
        ...
        // rx_carrier_nr:n
        //---------------------------------------------------------------------
        bool delete_obj_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool create_obj_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool create_obj_rsp__rx_carrier_nr(const rapidjson::Value& req_node,
                                            const std::string& node_key,
                                            const int &inst_id,
                                            const size_t uid,
                                            rapidjson::Value &rsp_node,
                                            ...
                                            size_t item_idx = 0,
                                            size_t num_item = 1);
        bool modify_param_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool get_param_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                           const std::string& node_key,
                                           const int &inst_id,
                                           const size_t uid,
                                           rapidjson::Value &rsp_node,
                                           ...
                                           size_t item_idx = 0,
                                           size_t num_item = 1);
        bool modify_state_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool modify_state_rsp__rx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
                                              ...
                                              size_t item_idx = 0,
                                              size_t num_item = 1);
        bool state_change_ind__rx_carrier_nr(const rapidjson::Value& req_node,
                                              const std::string& node_key,
                                              const int &inst_id,
                                              const size_t uid,
                                              rapidjson::Value &rsp_node,
