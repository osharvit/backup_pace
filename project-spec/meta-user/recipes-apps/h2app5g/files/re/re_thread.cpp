...
void re_thread::setup_hswi_handler()
{
    ...
    //---------------------------------------------------------------------
    // tx_carrier_nr:n from hswi_thread to re_thread
    //---------------------------------------------------------------------
    this->objid_map["hswi:/delete_obj_req/tx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::delete_obj_req__tx_carrier_nr);
    this->objid_map["hswi:/create_obj_req/tx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::create_obj_req__tx_carrier_nr);
    this->objid_map["hswi:/modify_param_req/tx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::modify_param_req__tx_carrier_nr);
    this->objid_map["hswi:/get_param_req/tx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::get_param_req__tx_carrier_nr);
    this->objid_map["hswi:/modify_state_req/tx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::modify_state_req__tx_carrier_nr);

    //---------------------------------------------------------------------
    // rx_carrier_nr:n from hswi_thread to re_thread
    //---------------------------------------------------------------------
    this->objid_map["hswi:/delete_obj_req/rx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::delete_obj_req__rx_carrier_nr);
    this->objid_map["hswi:/create_obj_req/rx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::create_obj_req__rx_carrier_nr);
    this->objid_map["hswi:/modify_param_req/rx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::modify_param_req__rx_carrier_nr);
    this->objid_map["hswi:/get_param_req/rx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::get_param_req__rx_carrier_nr);
    this->objid_map["hswi:/modify_state_req/rx_carrier_nr"] =
        static_cast<hswi_json::OBJID_FUNC>(&re_thread::modify_state_req__rx_carrier_nr);
    ...
    switch(req_node.GetType())
    {
        ...
        case  rapidjson::kObjectType: {
            ...
            for(rapidjson::Value::ConstMemberIterator itochild = req_node.MemberBegin(); itochild != req_node.MemberEnd(); ++itochild){
                ...
                if(instkey == "state"){
                ...
                else if(instkey == "dl_ul_periodicity"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].dl_ul_periodicity = itochild->value.GetDouble();
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].dl_ul_periodicity_x = (int)(itochild->value.GetDouble()*1000);
                        //TRACE0() << "dl_ul_periodicity=" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].dl_ul_periodicity << std::endl;
                        //std::cout << "dl_ul_periodicity_x=" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].dl_ul_periodicity_x << std::endl;
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                }
                else if(instkey == "nrofdl_slots"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nrofdl_slots = itochild->value.GetInt();
                        //TRACE0() << "nrofdl_slots=" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nrofdl_slots << std::endl;
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                }
                else if(instkey == "nrofdl_symbols"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nrofdl_symbols = itochild->value.GetInt();
                        //TRACE0() << "nrofdl_symbols=" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nrofdl_symbols << std::endl;
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                }
                else if(instkey == "nroful_slots"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nroful_slots = itochild->value.GetInt();
                        //TRACE0() << "nroful_slots=" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nroful_slots << std::endl;
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                }
                else if(instkey == "nroful_symbols"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nroful_symbols = itochild->value.GetInt();
                        //TRACE0() << "nroful_symbols" << tmplaybackreq.tmplaybackobj[tmplaybackreq.num_playbackobj].nroful_symbols << std::endl;
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                    ...
                    if(itochild->value.GetType() == rapidjson::kObjectType){
                        ...
                        // default value of fftsize is 2048 for a backward compatibility
                        p1section->fftsize = 2048;
                            ...
                            ++subchild)
                        {
                            ...
                            else if(sectionchildkey == "fft_size"){
                                if(subchild->value.GetType() == rapidjson::kNumberType){
                                    p1section->fftsize = subchild->value.GetInt();
                                }
                                else{
                                    TRACE0() << ">>> HSWI type error" << std::endl;
                                }
...
// tx_carrier_nr:n
//-------------------------------------------------------------------------------
bool re_thread::delete_obj_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                                   const std::string& node_key,
                                                   const int &inst_id,
                                                   const size_t uid,
                                                   rapidjson::Value &rsp_node,
                                                   ...
                                                   size_t num_item)
{
    ...
    for(std::vector<int>::iterator it = tx_carrier_nr_vec.begin(); it != tx_carrier_nr_vec.end(); ++it){
        if(*it == inst_id){
            status = true;
            break;
        }
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                delete_obj_req__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            send_hswi_msg_to_thread(THREAD_IL,
                                    ...
                                    std::string("req"),
                                    std::string("delete_obj_req"),
                                    std::string("tx_carrier_nr:0" + std::to_string(inst_id)),
                                    itcnode,
                                    itcdoc,
                                    itc_at);

            // TODO: mutex
            std::vector<int>::iterator it = tx_carrier_nr_vec.end();
            for(it = tx_carrier_nr_vec.begin(); it != tx_carrier_nr_vec.end(); ++it){
                if(*it == inst_id) {
                    // NOTE: do NOT call the "erase()" within this loop.
                    break;
                }
            }
            if(it != tx_carrier_nr_vec.end()){  // found
                tx_carrier_nr_vec.erase(it);
            }
            // update fst
            txcarrierobj[inst_id].transit_state(tx_carrier::NOT_OPERATIONAL_S, false);
            add_member(std::string("fst"), txcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
    ...
    return(status);  // true: valid object, false: invalid object
}   // end of bool re_thread::delete_obj_req__tx_carrier_nr()

bool re_thread::create_obj_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                create_obj_req__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            for(rapidjson::Value::ConstMemberIterator itochild = req_node.MemberBegin(); itochild != req_node.MemberEnd(); ++itochild){
                ...
                else if(currkey == "dl_ul_periodicity"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        txcarrierobj[inst_id].dl_ul_periodicity = itochild->value.GetDouble();
                        add_member(std::string("dl_ul_periodicity_x"), (int)(itochild->value.GetDouble()*1000), itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    }
                }
                else if(currkey == "nrofdl_slots"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        txcarrierobj[inst_id].nrofdl_slots = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                ...
                else if(currkey == "nrofdl_symbols"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        txcarrierobj[inst_id].nrofdl_symbols = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                ...
                else if(currkey == "nroful_slots"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        txcarrierobj[inst_id].nroful_slots = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                ...
                else if(currkey == "nroful_symbols"){
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        txcarrierobj[inst_id].nroful_symbols = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
            ...
            send_hswi_msg_to_thread(THREAD_IL,
                                    ...
                                    std::string("req"),
                                    std::string("create_obj_req"),
                                    std::string("tx_carrier_nr:" + std::to_string(inst_id)),
                                    itcnode,
                                    itcdoc,
                                    itc_at);
            ...
            // update fst
            if(it == tx_carrier_nr_vec.end()) { // new
                tx_carrier_nr_vec.push_back(inst_id);
                txcarrierobj[inst_id].set_obj_id(std::string("tx_carrier_nr:" + std::to_string(inst_id)));
                txcarrierobj[inst_id].transit_state(tx_carrier::NOT_OPERATIONAL_S, false);
            }
            add_member(std::string("fst"), txcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
            break;
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::create_obj_req__tx_carrier_nr()

bool re_thread::create_obj_rsp__tx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                create_obj_rsp__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::create_obj_rsp__tx_carrier_nr()

bool re_thread::modify_param_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
                                                     ...
                                                     size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_param_req__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_param_req__tx_carrier_nr()

bool re_thread::get_param_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                                  const std::string& node_key,
                                                  const int &inst_id,
                                                  const size_t uid,
                                                  rapidjson::Value &rsp_node,
                                                  ...
                                                  size_t num_item)
{
    ...
    for(size_t kk = 0; kk < tx_carrier_nr_vec.size(); kk++){
        if(tx_carrier_nr_vec[kk] == inst_id){
            // found
            found = true;
            break;
        }
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                get_param_req__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            add_member(std::string("duplex"), txcarrierobj[inst_id].is_tdd? std::string("tdd") : std::string("fdd"), rsp_node, rsp_at);
            add_member(std::string("tx_freq"), txcarrierobj[inst_id].tx_freq, rsp_node, rsp_at);
            add_member(std::string("dl_ul_periodicity"), txcarrierobj[inst_id].dl_ul_periodicity, rsp_node, rsp_at);
            add_member(std::string("nrofdl_slots"), txcarrierobj[inst_id].nrofdl_slots, rsp_node, rsp_at);
            add_member(std::string("nrofdl_symbols"), txcarrierobj[inst_id].nrofdl_symbols, rsp_node, rsp_at);
            add_member(std::string("nroful_slots"), txcarrierobj[inst_id].nroful_slots, rsp_node, rsp_at);
            add_member(std::string("nroful_symbols"), txcarrierobj[inst_id].nroful_symbols, rsp_node, rsp_at);
            add_member(std::string("tx_max_pwr"), txcarrierobj[inst_id].tx_max_pwr, rsp_node, rsp_at);
            add_member(std::string("fst"), txcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::get_param_req__tx_carrier_nr()

bool re_thread::modify_state_req__tx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
                                                     ...
                                                     size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_state_req__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_state_req__tx_carrier_nr()

bool re_thread::modify_state_rsp__tx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_state_rsp__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_state_rsp__tx_carrier_nr()

bool re_thread::state_change_ind__tx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                state_change_ind__tx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
...
// rx_carrier_nr:n
//-------------------------------------------------------------------------------
bool re_thread::delete_obj_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                                   const std::string& node_key,
                                                   const int &inst_id,
                                                   const size_t uid,
                                                   rapidjson::Value &rsp_node,
                                                   ...
                                                   size_t num_item)
{
    ...
    for(std::vector<int>::iterator it = rx_carrier_nr_vec.begin(); it != rx_carrier_nr_vec.end(); ++it){
        if(*it == inst_id){
            status = true;
            break;
        }
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                delete_obj_req__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            // TODO: mutex
            std::vector<int>::iterator it = rx_carrier_nr_vec.end();
            for(it = rx_carrier_nr_vec.begin(); it != rx_carrier_nr_vec.end(); ++it){
                if(*it == inst_id) {
                    // NOTE: do NOT call the "erase()" within this loop.
                    break;
                }
            ...
            send_hswi_msg_to_thread(THREAD_IL,
                                    ...
                                    std::string("req"),
                                    std::string("delete_obj_req"),
                                    std::string("rx_carrier_nr:" + std::to_string(inst_id)),
                                    itcnode,
                                    itcdoc,
                                    itc_at);

            if(it != rx_carrier_nr_vec.end()){ // found
                rx_carrier_nr_vec.erase(it);
            }
            // update fst
            rxcarrierobj[inst_id].transit_state(rx_carrier::NOT_OPERATIONAL_S, false);
            add_member(std::string("fst"), rxcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::delete_obj_req__rx_carrier_nr()

bool re_thread::create_obj_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                create_obj_req__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            for(rapidjson::Value::ConstMemberIterator itochild = req_node.MemberBegin(); itochild != req_node.MemberEnd(); ++itochild){
                ...
                if(currkey == "duplex"){
                    ...
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        rxcarrierobj[inst_id].dl_ul_periodicity = itochild->value.GetDouble();
                        add_member(std::string("dl_ul_periodicity_x"), (int)(itochild->value.GetDouble()*1000), itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    ...
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        rxcarrierobj[inst_id].nrofdl_slots = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    ...
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        rxcarrierobj[inst_id].nrofdl_symbols = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    ...
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        rxcarrierobj[inst_id].nroful_slots = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
                    ...
                    if(itochild->value.GetType() == rapidjson::kNumberType){
                        rxcarrierobj[inst_id].nroful_symbols = itochild->value.GetInt();
                        add_member(currkey, itochild->value, itcnode, itc_at);
                    }
                    else{
                        TRACE0() << ">>> HSWI type error" << std::endl;
            ...
            // update fst
            if(it == rx_carrier_nr_vec.end()) { // new
                rx_carrier_nr_vec.push_back(inst_id);
                rxcarrierobj[inst_id].set_obj_id(std::string("rx_carrier_nr:" + std::to_string(inst_id)));
                rxcarrierobj[inst_id].transit_state(rx_carrier::NOT_OPERATIONAL_S, false);
            }
            add_member(std::string("fst"), rxcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
            break;
    ...
    return(status);  // true: valid object, false: invalid object
}   // end of bool re_thread::create_obj_req__rx_carrier_nr()

bool re_thread::create_obj_rsp__rx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                create_obj_rsp__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::create_obj_rsp__rx_carrier_nr()

bool re_thread::modify_param_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
                                                     ...
                                                     size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_param_req__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_param_req__rx_carrier_nr()

bool re_thread::get_param_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                                  const std::string& node_key,
                                                  const int &inst_id,
                                                  const size_t uid,
                                                  rapidjson::Value &rsp_node,
                                                  ...
                                                  size_t num_item)
{
    ...
    for(size_t kk = 0; kk < rx_carrier_nr_vec.size(); kk++){
        if(rx_carrier_nr_vec[kk] == inst_id){
            // found
            found = true;
            break;
        }
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                get_param_req__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
        ...
        case  rapidjson::kObjectType: {
            ...
            add_member(std::string("duplex"), rxcarrierobj[inst_id].is_tdd? std::string("tdd") : std::string("fdd"), rsp_node, rsp_at);
            add_member(std::string("rx_freq"), rxcarrierobj[inst_id].rx_freq, rsp_node, rsp_at);
            add_member(std::string("dl_ul_periodicity"), rxcarrierobj[inst_id].dl_ul_periodicity, rsp_node, rsp_at);
            add_member(std::string("nrofdl_slots"), rxcarrierobj[inst_id].nrofdl_slots, rsp_node, rsp_at);
            add_member(std::string("nrofdl_symbols"), rxcarrierobj[inst_id].nrofdl_symbols, rsp_node, rsp_at);
            add_member(std::string("nroful_slots"), rxcarrierobj[inst_id].nroful_slots, rsp_node, rsp_at);
            add_member(std::string("nroful_symbols"), rxcarrierobj[inst_id].nroful_symbols, rsp_node, rsp_at);
            add_member(std::string("fst"), rxcarrierobj[inst_id].get_fst_str(), rsp_node, rsp_at);
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::get_param_req__rx_carrier_nr()

bool re_thread::modify_state_req__rx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
                                                     ...
                                                     size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_state_req__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_state_req__rx_carrier_nr()

bool re_thread::modify_state_rsp__rx_carrier_nr(const rapidjson::Value& req_node,
                                                    const std::string& node_key,
                                                    const int &inst_id,
                                                    const size_t uid,
                                                    rapidjson::Value &rsp_node,
                                                    ...
                                                    size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                modify_state_rsp__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // end of bool re_thread::modify_state_rsp__rx_carrier_nr()

bool re_thread::state_change_ind__rx_carrier_nr(const rapidjson::Value& req_node,
                                                     const std::string& node_key,
                                                     const int &inst_id,
                                                     const size_t uid,
                                                     rapidjson::Value &rsp_node,
                                                     ...
                                                     size_t num_item)
{
    ...
    switch(req_node.GetType())
    {
        case  rapidjson::kArrayType:{
            ...
            for(rapidjson::Value::ConstValueIterator ita = req_node.Begin(); ita != req_node.End(); ++ita)
            {
                rapidjson::Value    rspval(rapidjson::kObjectType);
                // recursive call
                state_change_ind__rx_carrier_nr(*ita, node_key, inst_id, uid, rspval, rsp_at);
                rsp_node.PushBack(rspval, rsp_at);
            }
            break;
        }
    ...
    return(status);  // true: valid object, false: invalid object
} // bool re_thread::state_change_ind__rx_carrier_nr()
